...
public class CodeGenerator {
    public static void main(String[] args) throws InterruptedException {
        ...
        gc.setOutputDir(projectPath + "/spring-cache/src/main/java");
        ...
        focList.add(new FileOutConfig("/templates/vm/mapper.xml.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPath + "/spring-cache/src/main/resources/mybatis/"
        ...
        focList.add(new FileOutConfig("/templates/vm/controller.java.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPath + "/spring-cache/src/main/java/com/dev/cache/controller/"
        ...
        focList.add(new FileOutConfig("/templates/vm/entity.java.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPath + "/spring-cache/src/main/java/com/dev/cache/entity/"
...
//        strategy.setSuperControllerClass("com.dev.cache.controller.BaseController");
